    ...
    <x-jet-form-section submit="makeSale">
        ...
        <x-slot name="form">     
            ...
            <div class="w-full space-y-2 col-span-6 space-y-1">
                ...
                <x-jet-input id="description" class="block w-full" type="text" placeholder="Product description" wire:model.defer="description">
                <x-jet-input-error for="description" />
            </div> 	
            <div class="w-full space-y-2 col-span-6 space-y-1">
                <x-jet-label for="price" value="{{ __('Price') }}"/>
                <x-jet-input id="price" class="block w-full" type="number" placeholder="Product name" wire:model.defer="price"/>
                <x-jet-input-error for="price" />
            </div> 	
            <div class="w-full space-y-2 col-span-6 space-y-1">
                <x-jet-label for="msl" value="{{ __('Minimum Stock Level') }}"/>
                <x-jet-input id="msl" class="block w-full" type="number" placeholder="Product msl" wire:model.defer="msl"/>
